...
class CenterNetHead(nn.Module):
    def __init__(self, cfg, input_shape: List[ShapeSpec]):
        ...
        head_configs = {
            "cls": (
                cfg.MODEL.CENTERNET.NUM_CLS_CONVS if not self.only_proposal else 0,
                cfg.MODEL.CENTERNET.USE_DEFORMABLE,
            ),
            "bbox": (cfg.MODEL.CENTERNET.NUM_BOX_CONVS, cfg.MODEL.CENTERNET.USE_DEFORMABLE),
            "share": (cfg.MODEL.CENTERNET.NUM_SHARE_CONVS, cfg.MODEL.CENTERNET.USE_DEFORMABLE),
        }
